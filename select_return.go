...
func (b *SelectBuilderSession) ReturnInt64() (int64, error) {
	var v int64
	err := b.LoadValue(&v)
	return v, err
}
...
func (b *SelectBuilderSession) ReturnInt64s() ([]int64, error) {
	var v []int64
...
func (b *SelectBuilderSession) ReturnUint64() (uint64, error) {
	var v uint64
	err := b.LoadValue(&v)
	return v, err
}
...
func (b *SelectBuilderSession) ReturnUint64s() ([]uint64, error) {
	var v []uint64
	_, err := b.LoadValues(&v)
	return v, err
}
...
func (b *SelectBuilderSession) ReturnString() (string, error) {
	var v string
	err := b.LoadValue(&v)
	return v, err
}
...
func (b *SelectBuilderSession) ReturnStrings() ([]string, error) {
	var v []string
	_, err := b.LoadValues(&v)
	return v, err
}
